...
# Valid permissions (College update)
print(label_result_format("Valid permissions (College update)",remove_room_assignment('rrodriguez',471,'053-0','0220-00')))
# Valid permissions (Department update)
print(label_result_format("Valid permissions (Department update)",remove_room_assignment('wliu',471,'053-0','0220-00')))
